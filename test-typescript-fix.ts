/**
 * 🧪 Teste de Correção de Tipos TypeScript
 * 
...
// Simula a interface ValidationResult
...
// Simula o tipo usado no batchResults
type BatchResult = ValidationResult & { responseTime: number; postalCode: string };
