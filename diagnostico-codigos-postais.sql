...
SELECT 
  ...
  CASE 
    ...
    WHEN zip_code ~ '^\d{4}-\d{3}$' THEN 'VÁLIDO'
...
-- 2. Se houver códigos inválidos, o script principal irá corrigi-los automaticamente
-- 3. Códigos com exatamente 7 dígitos serão formatados para XXXX-XXX
-- 4. Códigos que não podem ser corrigidos serão definidos como NULL
