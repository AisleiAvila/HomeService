-- ================================================================
-- MIGRAÇÃO ALTERNATIVA: Para sistemas com esquema Supabase padrão
-- Use este script se a tabela de usuários for 'profiles' em vez de 'users'
-- ================================================================
...
-- 8. Criar view para relatórios de agendamento (versão com tabela 'profiles')
...
COMMENT ON VIEW vw_service_scheduling_report IS 'View consolidada para relatórios de agendamento e controle de tempo dos serviços (versão para tabela profiles)';
...
DO $$
BEGIN
    RAISE NOTICE '✅ Migração alternativa (profiles) concluída com sucesso!';
    RAISE NOTICE '📊 Novos campos adicionados à tabela service_requests';
    RAISE NOTICE '🔧 Funções e triggers criados';
    RAISE NOTICE '📈 View vw_service_scheduling_report criada usando tabela profiles';
END $$;
