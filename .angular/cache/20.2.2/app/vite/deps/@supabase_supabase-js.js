...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./browser-2A7DI5HU.js").then(({ default: fetch2 }) => fetch2(...args));
  } else {
    _fetch = fetch;
  }
...
var RealtimeClient = class {
  ...
  connect() {
    ...
    import("./browser-HBAD7HAT.js").then(({ default: WS }) => {
...
var resolveResponse = () => __awaiter2(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-2A7DI5HU.js")).Response;
  }
  return Response;
});
