...
@Component({
  ...
  template: `
    ...
    <header
      class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-linear-to-r from-brand-primary-500 to-brand-primary-600"
      role="banner"
    >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6" [attr.aria-labelledby]="'request-info-title'">
            <div class="space-y-4">
              <div>
                ...
                <p class="text-gray-900 dark:text-gray-100 wrap-break-word" [attr.aria-labelledby]="'title-label'">
                  {{ request().title }}
                </p>
              </div>
              <div>
                ...
                <p class="text-gray-900 dark:text-gray-100 wrap-break-word" [attr.aria-labelledby]="'description-label'">
                  {{ request().description }}
                </p>
              </div>
        ...
        >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-gray-900 dark:text-gray-100" [attr.aria-labelledby]="'requester-info-title'">
            ...
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'client-name-label'">
                {{ request().client_name }}
              </p>
            </div>
            }
            ...
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'client-phone-label'">
                {{ request().client_phone }}
              </p>
            </div>
            }
            ...
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'client-nif-label'">
                {{ request().client_nif }}
              </p>
            </div>
            }
            ...
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'client-email-label'">
                {{ request().email_client }}
              </p>
            </div>
            }
        ...
        >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-900 dark:text-gray-100" [attr.aria-labelledby]="'address-title'">
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'postal-code-label'">
                {{ request().zip_code || "—" }}
              </p>
            </div>
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'street-label'">
            ...
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'number-label'">
            ...
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'complement-label'">
                {{ request().complement || "—" }}
              </p>
            </div>
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'locality-label'">
            ...
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'city-label'">
                {{ request().city || "—" }}
              </p>
            </div>
            <div>
              ...
              <p class="wrap-break-word" [attr.aria-labelledby]="'district-label'">
                {{ request().state || "—" }}
              </p>
            </div>
          </div>
