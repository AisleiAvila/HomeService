...
const allTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    clients: "Users",
    tenants: "Tenants",
    tenantManagementSubtitle: "Manage tenant profile data (name, contact and status)",
    ...
    tenantLogoImage: "Logo Image",
    tenantLogoInvalidType: "Invalid image format. Use PNG, JPG, or WEBP.",
    tenantLogoTooLarge: "Image is too large. Maximum size is 2MB.",
    tenantLogoPreviewAlt: "Tenant logo preview",
    ...
    authAccessDenied: "Access denied for this account in the current tenant.",
    tenantBillingBlocked: "Your company account is temporarily blocked due to pending subscription payment. Please regularize billing to continue.",
    tenantBillingTitle: "Tenant Billing",
    tenantBillingAccessLabel: "Access",
    tenantBillingAccessAllowed: "Allowed",
    tenantBillingAccessBlocked: "Blocked",
    tenantBillingStatusLabel: "Subscription Status",
    tenantBillingPeriodEndLabel: "Current Period End",
    tenantBillingGraceLabel: "Grace Until",
    tenantBillingPaymentStatusLabel: "Payment Status",
    tenantBillingProviderSubscriptionLabel: "Provider Subscription ID",
    tenantBillingAmountCentsLabel: "Amount (cents)",
    tenantBillingUpdateAction: "Update Subscription",
    tenantBillingInvoicesTitle: "Recent Invoices",
    tenantBillingNoInvoices: "No invoices found for this tenant.",
    tenantBillingOpenCheckout: "Open Checkout",
    tenantBillingOpenPortal: "Open Billing Portal",
    dueDate: "Due Date",
  ...
  pt: {
    ...
    clients: "Usuários",
    tenants: "Tenants",
    tenantManagementSubtitle: "Gerencie os dados do tenant (nome, contacto e status)",
    selectTenant: "Selecionar tenant",
    noTenantsAvailable: "Nenhum tenant disponível",
    tenantProfileNotFound: "Perfil do tenant não encontrado",
    tenantStatusActive: "Ativo",
    tenantStatusInactive: "Inativo",
    tenantLogoImage: "Imagem do Logo",
    tenantLogoInvalidType: "Formato de imagem inválido. Use PNG, JPG ou WEBP.",
    tenantLogoTooLarge: "Imagem muito grande. Tamanho máximo de 2MB.",
    tenantLogoPreviewAlt: "Pré-visualização do logo do tenant",
    removeImage: "Remover Imagem",
    invalidUrl: "Informe uma URL válida (http/https).",
    ...
    authAccessDenied: "Acesso negado para esta conta no tenant atual.",
    tenantBillingBlocked: "A conta da sua empresa está temporariamente bloqueada por pendência no pagamento da assinatura. Regularize a cobrança para continuar.",
    tenantBillingTitle: "Cobrança do Tenant",
    tenantBillingAccessLabel: "Acesso",
    tenantBillingAccessAllowed: "Permitido",
    tenantBillingAccessBlocked: "Bloqueado",
    tenantBillingStatusLabel: "Status da Assinatura",
    tenantBillingPeriodEndLabel: "Fim do Período Atual",
    tenantBillingGraceLabel: "Tolerância até",
    tenantBillingPaymentStatusLabel: "Status do Pagamento",
    tenantBillingProviderSubscriptionLabel: "ID da Assinatura no Provedor",
    tenantBillingAmountCentsLabel: "Valor (cêntimos)",
    tenantBillingUpdateAction: "Atualizar Assinatura",
    tenantBillingInvoicesTitle: "Faturas Recentes",
    tenantBillingNoInvoices: "Nenhuma fatura encontrada para este tenant.",
    tenantBillingOpenCheckout: "Abrir Checkout",
    tenantBillingOpenPortal: "Abrir Portal de Cobrança",
