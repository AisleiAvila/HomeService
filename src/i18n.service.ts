...
const allTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    deleteRequestWarning: "This service request will be permanently removed. This action cannot be undone.",
    deleteRequestQuestion: "Do you really want to permanently delete this service request?",
  ...
  pt: {
    ...
    deleteRequestWarning: "Esta solicitação de serviço será removida em definitivo. Esta ação não pode ser desfeita.",
    deleteRequestQuestion: "Deseja realmente excluir em definitivo esta solicitação de serviço?",
