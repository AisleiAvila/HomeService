...
const allTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    confirmDeleteClarification: "Are you sure you want to delete this clarification?",
  ...
  pt: {
    ...
    confirmDeleteClarification: "Tem certeza de que deseja eliminar este esclarecimento?",
